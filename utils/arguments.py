...
def get_arguments():
    ...
    parser.add_argument('--scheduler', default='MultiStepLR', type=str, choices=['MultiStepLR','CosineAnnealing','CosineWarmup','StepLR'])
...
def get_MentorNet_arguments():
    ...
    parser.add_argument('--scheduler', default='MultiStepLR_Mentor', type=str, choices=['MultiStepLR_Mentor','MultiStepLR','CosineAnnealing','CosineWarmup','StepLR'])
    parser.add_argument('--wd', '--weight_decay','--wdecay', default=2e-4, type=float, choices=[5e-4,1e-2,2e-4,1e-3,1e-4,1e-6])
